...
@section('content')
    <section class="pb-0" id="about">
        ...
        <div class="text-center">
            <img class="col-6 col-sm-6 col-md-4 col-lg-2 mb-3" src="{{ asset("visitor/assets/img/qrcode/Kuesioner Kepuasan Pelayanan RSUD dr. M. Haulussy Ambon (1).png") }}" alt=""><br>
