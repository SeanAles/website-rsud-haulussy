...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row pb-5">
            ...
            <!-- Modal -->
            <div class="modal fade" id="dalam" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="col-4 col-md-4 col-lg-2 text-xl-start mb-5">
                <div class="d-flex flex-column align-items-center">
                    <div class="icon-box text-center">
                        <a class="stretched-link text-decoration-none" role="button" data-bs-toggle="modal"
                            data-bs-target="#bedahUmum" style="font-size: 30px"><i class="fa-solid fa-head-side-mask"></i>
            ...
            <!-- Modal -->
            <div class="modal fade" id="bedahUmum" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Poliklinik</h1>
            ...
            <div class="modal fade" id="bedahVaskular" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <div class="text-center">
                            <div class="modal-body">
                                <img src="{{ 'visitor/assets/img/poli/bedahVaskular.jpg' }}" width="100%" height="100%"
                                    alt="Bedah Vaskular">
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-4 col-md-4 col-lg-2 text-xl-start mb-5">
                <div class="d-flex flex-column align-items-center">
                    <div class="icon-box text-center">
                        <a class="stretched-link text-decoration-none" role="button" data-bs-toggle="modal"
                            data-bs-target="#asma" style="font-size: 30px"><i class="fa-solid fa-head-side-cough"></i>
            ...
            <div class="col-4 col-md-4 col-lg-2 text-xl-start mb-5">
                <div class="d-flex flex-column align-items-center">
                    <div class="icon-box text-center">
                        <a class="stretched-link text-decoration-none" role="button" data-bs-toggle="modal"
                            data-bs-target="#bidan" style="font-size: 30px"><i class="fa-solid fa-person-pregnant"></i>
            ...
            <div class="col-4 col-md-4 col-lg-2 text-xl-start mb-5">
                <div class="d-flex flex-column align-items-center">
                    <div class="icon-box text-center">
                        <a class="stretched-link text-decoration-none" role="button" data-bs-toggle="modal"
                            data-bs-target="#endoskopi" style="font-size: 30px"><i class="fa-solid fa-microscope"></i>
            ...
            <div class="modal fade" id="endoskopi" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <div class="text-center">
                            <div class="modal-body">
                                <img src="{{ 'visitor/assets/img/poli/endoskopi.jpg' }}" width="100%" height="100%"
                                    alt="Endoskopi">
                            </div>
                        </div>
                    </div>
        ...
        <div class="row pb-5">
            ...
            <div class="col-4 col-md-4 col-lg-2 text-xl-start mb-5">
                <div class="d-flex flex-column align-items-center">
                    <div class="icon-box text-center">
                        <a class="stretched-link text-decoration-none" role="button" data-bs-toggle="modal"
                            data-bs-target="#kulit" style="font-size: 30px"><i class="fa-solid fa-face-smile-beam"></i>
            ...
            <div class="modal fade" id="fisioterapi" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog ">
                    <div class="modal-content">
                        ...
                        <div class="text-center">
                            <div class="modal-body">
                                <img src="{{ 'visitor/assets/img/poli/fisioterapi.jpg' }}" width="100%" height="100%"
                                    alt="Fisioterapi">
                            </div>
                        </div>
                    </div>
