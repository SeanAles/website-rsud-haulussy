            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <button class="accordion btn btn-primary mt-3" onclick="toggleDoctorPanel('DokterA')">dr. Helfi
                            Nikijuluw, Sp.B KBD
                        </button>
                        <div class="panel" id="DokterA">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_cewe.png') }}" alt="Foto Dokter A"
                                id="doctor-image" />
                        </div>
                        ...
                        <button class="accordion btn btn-primary" onclick="toggleDoctorPanel('DokterF')">drg. Lina Mardiana
                        </button>
                        ...
                        <button class="accordion btn btn-primary" onclick="toggleDoctorPanel('DokterG')">dr. Jacky Tuamelly,
                            Sp.B
                        </button>
                        ...
                        <button class="accordion btn btn-primary" onclick="toggleDoctorPanel('DokterF')">dr. Ingrid Angeline
                            Hutagalung, Sp.PK, M.Kes
                        </button>
                        <div class="panel" id="DokterF">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_cewe.png') }}" alt="Foto Dokter F"
                                id="doctor-image" />
                        ...
                        <div class="panel" id="DokterL">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_laki.png') }}" alt="Foto Dokter L"
                                id="doctor-image" />
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6" style="margin-top: 16px">
                        ...
                        <div class="panel" id="DokterU">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_laki.png') }}" alt="Foto Dokter U"
                                id="doctor-image" />
                        </div>
                        ...
                        <div class="panel" id="DokterY">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_cewe.png') }}" alt="Foto Dokter Y"
                                id="doctor-image" />
                        </div>
                        ...
                        <div class="panel" id="DokterEE">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_cewe.png') }}" alt="Foto Dokter EE"
                                id="doctor-image" />
                        </div>
                        ...
                        <div class="panel" id="DokterFF">
                            <img src="{{ asset('visitor/assets/img/avatar/avatar_laki.png') }}" alt="Foto Dokter FF"
                                id="doctor-image" />
                        </div>
                        ...
                        <button class="accordion btn btn-primary" onclick="toggleDoctorPanel('DokterKK')">dr. Fitri
                            Kadarsih Bandjar, Sp.KK
                        </button>
                        ...
                        <button class="accordion btn btn-primary" onclick="toggleDoctorPanel('DokterOO')">dr. Achmad
                            Tuahuns, Sp.B
                        </button>
