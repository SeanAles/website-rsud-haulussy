        ...
        <div class="p-3">
            <div class="row align-items-center">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 order-lg-1 mb-5 mb-lg-0 text-center">
                    <img class="img-fluid rounded-circle" src="{{ asset('visitor/assets/img/gallery/direk.png') }}"
                        alt="..." />
                    <div class="text-center">
                        <h4>DIREKTUR</h4>
                ...
                <div class="col-lg-6 z-index-2">
                    <form class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input class="form-control form-livedoc-control" id="name" type="text"
                                placeholder="Nama" />
                        </div>
                        <div class="col-md-12">
                            <label class="form-label visually-hidden" for="email">Email</label>
                            <input class="form-control form-livedoc-control" id="email" type="email"
                                placeholder="Email" />
                        </div>

                        <div class="col-md-12">
                            <label class="form-label visually-hidden" for="nomor_hp">No Handphone</label>
                            <input class="form-control form-livedoc-control" id="nomor_hp" type="number"
                                placeholder="No Handphone" />
                        </div>

                        <div class="col-md-12">
                            <label class="form-label visually-hidden" for="validationTextarea">Pesan</label>
                            <textarea class="form-control form-livedoc-control" id="validationTextarea" style="font-style:italic"
                                maxlength="100" placeholder="Pesan Maksimum 100 karakter" style="height: 250px" required="required"></textarea>
                        </div>
                        <div class="col-12">
                            <div class="d-grid">
