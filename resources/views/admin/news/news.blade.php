            ...
            <div class="col-12">
                <div class="article-card">
                    <div class="article-card-header">
                        ...
                        <a href="/news-add" class="btn-create">
                    ...
                    <div class="article-card-body">
                        ...
                        <div class="article-stats mb-4">
                            ...
                            <div class="stat-item">
                                <div class="stat-value" id="recentNews">0</div>
    ...
    <script>
        ...
        var table = $('.data-table').DataTable({
            ...
            language: {
                ...
                "emptyTable": "<div class='empty-state'><i class='fas fa-file-alt fa-3x mb-3'></i><h4>Belum Ada Berita</h4><p>Berita yang Anda buat akan muncul di sini</p></div>",
        ...
        function updateStats(json) {
            try {
                ...
                const totalNews = json.recordsTotal || 0;
        ...
        function styleActionButtons() {
            ...
            // Add tooltips
            $('.btn-view').attr('title', 'Lihat Berita');
            $('.btn-edit').attr('title', 'Edit Berita');
            $('.btn-delete').attr('title', 'Hapus Berita');
        }
