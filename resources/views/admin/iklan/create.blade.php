            ...
            <div class="col-12">
                <div class="iklan-form-card">
                    <div class="iklan-form-header">
                        <div>
                            <i class="material-icons-round mr-2" style="font-size: 24px; vertical-align: middle;">add_circle</i>
                            <span>Tambah Iklan Baru</span>
                        </div>
                    </div>
                    <div class="iklan-form-body">
                        <form action="{{ route('iklan.store') }}" method="POST" enctype="multipart/form-data" id="formIklan">
